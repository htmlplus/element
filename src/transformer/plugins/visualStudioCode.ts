...
export const VISUAL_STUDIO_CODE_OPTIONS: InvertOptional<VisualStudioCodeOptions> = {
...
export const visualStudioCode = (userOptions?: VisualStudioCodeOptions): TransformerPlugin => {
	...
	const options = Object.assign(
		...
		userOptions
	) as Required<VisualStudioCodeOptions>;
