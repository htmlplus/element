...
type OverrideKeys<Base, Overrides = unknown> = Exclude<Base, {
    [K in keyof Overrides]: Overrides[K] extends false ? K : never;
}[keyof Overrides]> | {
    [K in keyof Overrides]: Overrides[K] extends true ? K : never;
}[keyof Overrides];
type OverridesConfig<Breakpoint extends string, Overrides, Properties = unknown> = {
    [Key in OverrideKeys<Breakpoint, Overrides>]?: Partial<Properties>;
};
declare function Overrides(): (target: HTMLPlusElement, key: string) => void;

type PropertyOverridable<Base, Overrides = unknown> = Exclude<Base, {
    [K in keyof Overrides]: Overrides[K] extends false ? K : never;
}[keyof Overrides]> | {
    [K in keyof Overrides]: Overrides[K] extends true ? K : never;
}[keyof Overrides];
...
export type { Config, ConfigOptions, EventEmitter, EventOptions, ListenOptions, OverridesConfig, PropertyOptions, PropertyOverridable };
